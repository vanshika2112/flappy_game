...
FPS = 32 #number of times images generated per second
SCREENWIDTH = 289
SCREENHEIGHT = 550
SCREEN = pygame.display.set_mode((SCREENWIDTH, SCREENHEIGHT))
GROUNDY = SCREENHEIGHT * 0.8
GAME_SPRITES = {} #dictionary for images
GAME_SOUNDS = {}  #dictionary for sounds
PLAYER = 'gallery/images/bird.png'      #bird
    ...
    while True:
        for event in pygame.event.get():
            ...
            # If the user presses space or up key, start the game for them
                ...
                pygame.display.update() #toupdate all the value for pygame attributes 
                FPSCLOCK.tick(FPS)
...
def mainGame():
    ...
    # Create 2 pipes for blitting on the screen(upside and downside)
    ...
    while True:
        ...
        if crashTest:
            SCREEN.blit(pygame.image.load('gallery/images/game_over.png').convert_alpha(), (SCREENWIDTH/5,SCREENHEIGHT/4)) 
        ...
        for pipe in upperPipes:
            ...
            if pipeMidPos<= playerMidPos < pipeMidPos +4: #if player centre exceeds pipe center then increase 
                                                                 #the score 
                score +=1
        ...
        if playerFlapped:
            playerFlapped = False     #to check if player is using upper arrow key again nd again or not        
